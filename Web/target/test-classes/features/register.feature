Feature: Registration
  ...
  Scenario Outline: Registration scenario
    ...
    Examples:
      ...
      |sonyaprds|         |SonyaPrds1511|SonyaPrds1511|register page|
      ...
      |same|sonya@gmail.com|SonyaPrds1511|SonyaPrds1511|register page|
      |sonyaprds|same|SonyaPrds1511|SonyaPrds1511|register page|
      |sonyaprds|sonya@gmail.com|same|SonyaPrds1511|register page|
